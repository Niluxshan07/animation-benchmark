<template>
  <div class="page">
    <div v-if="modal" class="modal-overlay" @click="closeModal">
      <div class="modal-box" @click.stop>
        ...
        <div class="modal-body">
          <div v-for="(item, index) in modal.content" :key="index" class="modal-item">
    ...
    <nav class="navbar">
      ...
      <div class="level-badge">Level 4 — Spring Physics</div>
    </nav>

    <section class="hero">
      <div class="hero-left">
        <p class="badge">🔬 Research Project — SUSL</p>
        <h1>Animation <span class="highlight">Performance</span> Benchmark- Vue.js</h1>
        ...
        <div class="hero-buttons">
          <button class="btn-primary" @click="openResearchModal">View Research</button>
          <button class="btn-secondary" @click="openLearnMoreModal">Learn More</button>
        </div>
...
export default {
  ...
  setup() {
    ...
    const openResearchModal = () => { modal.value = researchInfo }
    const openLearnMoreModal = () => { modal.value = learnMore }
    ...
    return { modal, openResearchModal, openLearnMoreModal, closeModal }
  }
}
</script>
